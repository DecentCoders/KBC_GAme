...
[![GitHub Repo](https://img.shields.io/badge/GitHub-DecentCoders/KBC_GAme-181717?logo=github)](https://github.com/DecentCoders/KBC_GAme)
[![Last Commit](https://img.shields.io/github/last-commit/DecentCoders/KBC_GAme)](https://github.com/DecentCoders/KBC_GAme/commits/main)
[![Top Language](https://img.shields.io/github/languages/top/DecentCoders/KBC_GAme)](https://github.com/DecentCoders/KBC_GAme)
...
### Prerequisites
You only need **Python 3.6 or higher** installed on your local machine. You can download Python from [python.org](https://www.python.org/) if you don't have it already.

### Run the Game
1. Clone or download this repository to your local machine:
   ```bash
   git clone https://github.com/DecentCoders/KBC_GAme.git
   cd KBC_GAme
   ```
